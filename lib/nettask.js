...
* @param [{String} config.action] default 'ping'
* @param [{Object} config.actionConfig] default function of action value
...
NetTask.sanitizeConfig = function(config){
	...
	// action
	cleanConfig.action = config.action || "ping";
	
	// action configuration
	cleanConfig.actionConfig = config.config;	
