...
* @param {NetTask} task
*/
NetTaskSet.prototype._onTaskStart = function (config, task) {
...
* @param {Object} msg
*/
NetTaskSet.prototype._onTaskProgress = function (config, task, msg) {
...
*/
NetTaskSet.prototype._onTaskResult = function (err, config, response, task) {
	if (err) {
...
* @method
*/
NetTaskSet.prototype._log = function() {
    if (!this.verbose) {
        return;
    }
    var args = arguments,
