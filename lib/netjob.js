...
NetJob = function (config) {
	...
	this._taskSetCollection.on('result', this._onTaskResult.bind(this));
...
*/
NetJob.prototype._onTaskResult = function (err, data, task) {
	this.emit('result', err, data, task, this);
};
